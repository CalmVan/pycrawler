import requests
res = requests.get('https://maoyan.com/board/4')
res.encoding = 'utf-8'
# print(res.text)
html = res.text
...
#       src: url('//vfile.meituan.net/colorstone/9240fc12930d657e6943346699cc78623168.eot');
#       src: url('//vfile.meituan.net/colorstone/9240fc12930d657e6943346699cc78623168.eot?#iefix') format('embedded-opentype'),
#            url('//vfile.meituan.net/colorstone/f20946ec9824ea3f10a5d9a521447c9d2084.woff') format('woff');
#     }
#
#     .stonefont {
#       font-family: stonefont;
...
#     <div class="wrapper">
#         <div class="main">
#             <p class="update-time">2019-07-22<span class="has-fresh-text">已更新</span></p>
